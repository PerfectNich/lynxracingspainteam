...
>(({ className, transition, ...props }, ref) => {
  return (
    <motion.button
      ...
      ref={ref}
      className={cn(
        "group relative flex w-fit items-center rounded-full border border-lynx-orange bg-black/10 px-6 py-3 shadow-orange-glow transition-colors hover:bg-black/50",
        className
      )}
      transition={transition}
      {...props}
